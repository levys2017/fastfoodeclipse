package br.com.levys.fastfood.bean;
	...
	public class SecFilter implements Filter{   
	    //Pagina de login   
	    private static final String SIGNON_PAGE_URI = "/welcome.jsf";   
	    ...
	    public void doFilter( ServletRequest req, ServletResponse res, FilterChain chain ) throws IOException, ServletException{   
	        ...
	        if( !this.authorize( (HttpServletRequest)req ) ){   
	         ...
	         ((HttpServletResponse) response).sendRedirect(session.getServletContext().getContextPath() + "/welcome.jsf"); 
	    ...
	    private boolean authorize( HttpServletRequest req ){   
	        ...
	        if(session != null){   
	            ...
	            Usuario acesso = (Usuario) session.getAttribute("usuario");           
